...
import Channels from '../../Components/ChannelsBox'
import MessagesForm from '../../Components/MessagesBox'
		...
		<div className='chat'>
			<div className='chat__channels'>
				<div className='chat__channels__header'>
					...
					<button data-id={null} onClick={handleUserAction('addChannel')} type='button' className='add_btn'>
			...
			<PopUpLayout modalInfo={modalInfo} handleClose={handleClose} setActiveChannel={setActiveChannel} activeChannelId={activeChannelId} />
		</div>
	)
}
